#!/usr/bin/env python
"""
Export a Workflow instance (workflow run) to an archive file using.
...
def create_archive(export_directory, out_file, gzip=False):
    ...
    try:
        ...
        # Status.
        print('Created workflow archive.')
        return 0
    except Exception as e:
        print('Error creating workflow archive: %s' % unicodify(e), file=sys.stderr)
        return 1
